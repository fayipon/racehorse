...
export default function App() {
  ...
  const toggleSound = () => { if (muted) { sound.current ??= new AudioContext(); void sound.current.resume() }; setMuted(!muted) }
  return <>
